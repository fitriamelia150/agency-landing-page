const Testimoni = () => {
    return (
        <div className="py-20 px-5 flex flex-col justify-center items-center gap-10">
            ...
            <div className="flex flex-col justify-center items-center gap-5">
                ...
                <p className="text-center font-barlow font-semibold text-dark-grayish-blue">We put our trust in Sunnyside and they delivered, making sure our needs were met and deadlines were always hit.</p>
            ...
            <div className="flex flex-col justify-center items-center gap-5">
                ...
                <p className="text-center font-barlow font-semibold text-dark-grayish-blue">Sunnyside's enthusiasm coupled with their keen interest in our brand's success made it a satisfying and enjoyable experience.</p>
            ...
            <div className="flex flex-col justify-center items-center gap-5">
                ...
                <p className="text-center font-barlow font-semibold text-dark-grayish-blue">Incredible end result! Our sales increased over 400% when we worked with Sunnyside. Highly recommended!</p>
